...
import tn.err.InconsistencyException;
...
public class Path extends Route{
	 ...
	 */
	public Path(TrafficNetwork network, List<Integer> path) throws InvalidPath{
		super(network);
	...
	public Path(TrafficNetwork network, Integer link){	
		super(network);
	 ...
	 */
	public Path(TrafficNetwork network, Path pl, Path pr) {
		super(network);
