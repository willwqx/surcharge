...
public class Demand2change {
	...
	class Demandchange2{
		public class CostProperty extends LinkReadOnlyProperty<Double> {
			...
			public CostProperty() {
				super("S-Cost", Demand2change.this.trafficNetwork, 0.0);
			}

			@Override
			public Double get(int linkId) {				
				return Demandchange2.this.T.get(linkId);
			}
		...
		*/
		...
		private void calculateShortestPath(){			
			shortestroute = new ShortestPathRouter(trafficNetwork, S, null);
	   ...
	   /* private void UEAssignment() throws FileNotFoundException
		...
		private void showResult(){
			showIteration();
			System.out.println("dfadswegrwgwag");
			//demand.add(new ODPair(2,15), 200);
    ...
    public static void main(String[] args) {
    	Demand2change networkTest = new Demand2change();
    	networkTest.test();
    }	
}
